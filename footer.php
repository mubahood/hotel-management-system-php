...
<!--end::Content-->
<!--begin::Footer-->
<div class="footer py-4 d-flex flex-lg-column bg-primary text-white py-10" id="kt_footer">
	<!--begin::Container-->
	<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
		<!--begin::Copyright-->
		<div class="text-dark order-2 order-md-1">
			<span class=" fw-bold me-1  text-white">2022©</span>
			<a href="javascript:;" javascript:; class="text-white"><?= $APP_NAME ?></a>
		</div>
		<!--end::Copyright-->
		<!--begin::Menu-->
		<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
			<li class="menu-item">
				<a href="javascript:;" javascript:; class=" text-white px-2">About</a>
			</li>
			<li class="menu-item">
				<a href="javascript:;" javascript:; class=" text-white px-2">Support</a>
			</li>
			<li class="menu-item">
				<a href="javascript:;" javascript:; class=" text-white px-2">Contact Us</a>
			</li>
		</ul>
		<!--end::Menu-->
	</div>
